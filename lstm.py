...
def read_data(fname):
	...
	overview_cat = df.overview.str.cat(sep=' ')
...
if __name__ == "__main__":
	# load the data 
	ckpt_file = ""
	training_file = 'tmdb-5000-movie-dataset/tmdb_5000_movies.csv'
	...
	for i in range(len(TEST_PREFIX)):
		out = net.run_step(create_vectors(TEST_PREFIX[i], vocab) , i==0)
	...
	for i in range(LEN_TEST_TEXT):
		...
		out = net.run_step(create_vectors(vocab[element], vocab) , False )
	print (gen_str)
